// src/lib.rs
/*
 * Core library for CryptoAutomator
 */
...
#[derive(Debug)]
pub struct CryptoAutomatorProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CryptoAutomatorProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CryptoAutomator processing");
    
    let mut processor = CryptoAutomatorProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CryptoAutomatorProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CryptoAutomatorProcessor::new(false);
